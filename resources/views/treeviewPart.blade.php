<span class="card card-success detail2">
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->qaida }}"><span class="unwanat">قاعدہ:</span><span class="qaida">{{ $easy->qaida }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="mr-2 wazahat" title="{{ $detail->detail }}"><span class="unwanat">مختصر وضاحت:</span><span class="mukhtasar">{{ $detail->detail }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        ...
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->amli_mashq }}"><span class="unwanat">عملی :</span><span>{{ $easy->amli_mashq }}</span></div>
        </div>
    </div>
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->hukam }}"><span class="unwanat">حکم:</span><span class="hukam">{{ $easy->hukam }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->mukhatab }}"><span class="unwanat">مخاطب:</span><span>{{ $easy->mukhatab }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->jins }}"><span class="unwanat">جنس:</span><span>{{ $easy->jins }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->hasiat }}"><span class="unwanat">حیثیت:</span><span>{{ $easy->hasiat }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->shoba }}"><span class="unwanat">شعبہ:</span><span>{{ $easy->shoba }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="mr-2 wazahat" title="{{ $easy->area }}"><span class="unwanat">علاقہ:</span><span>{{ $easy->area }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $detail->age }}"><span class="unwanat">عمر:</span><span>{{ $detail->age }}</span></div>
        </div>
        <div class="ltopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->class }}"><span class="unwanat">جماعت:</span><span>{{ $easy->class }}</span></div>
        </div>
        <div class="ltopic mahol d-flex align-items-center">

            <div class="mr-2 wazahat" title="{{ $easy->muharik }}"><span>{{ 'نیک صحبت میں ماحول مہیا کرنا ' }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $yaad->ahwal }}"><span class="unwanat">احوال:</span><span>{{ $yaad->ahwal }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->sunana }}"><span class="unwanat">سنانا:</span><span>{{ $mahol->sunana }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->kehalwana }}"><span class="unwanat">کہلوانا:</span><span>{{ $mahol->kehalwana }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->dekhana }}"><span class="unwanat">دکھانا:</span><span>{{ $mahol->dekhana }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        <div class="stopic d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $easy->zamana }}"><span class="unwanat">زمانہ:</span><span>{{ $easy->zamana }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->mashq }}"><span class="unwanat">مشق:</span><span>{{ $mahol->mashq }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->batana }}"><span class="unwanat">بتانا:</span><span>{{ $mahol->batana }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->sikhana }}"><span class="unwanat">سکھانا:</span><span>{{ $mahol->sikhana }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
    ...
    <div class="d-xl-flex justify-content-between">
        ...
        <div class="stopic smahol d-flex align-items-center">
            ...
            <div class="tabs mr-2" title="{{ $mahol->adat }}"><span class="unwanat">عادت:</span><span>{{ $mahol->adat }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->samjhana }}"><span class="unwanat">سمجھانا:</span><span>{{ $mahol->samjhana }}</span></div>
        </div>
        <div class="stopic smahol d-flex align-items-center">
            <div class="dot">
            </div>
            <div class="tabs mr-2" title="{{ $mahol->parhana }}"><span class="unwanat">پڑھانا:</span><span>{{ $mahol->parhana }}</span></div>
        </div>
        <div class="stopic d-flex align-items-center">
            <div class="dot">
            </div>
