            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.parent2Title == null) {
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(61, 151, 230)");
                    }
                    if (
                        data.parent3Title == null &&
                        data.parent2Title != null
                    ) {
                        $("#ctab6")
                            .children("#ct6_title")
                            .html(
                        ...
                        $("#ctab5")
                            .children("#ct5_title")
                            .html(data.parent2Title);
                        $("#ctab6")
                            .children("#ct6_title")
                            .css("color", "rgb(61, 151, 230)");
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(230, 122, 51)");
                    }
                    if (
                        data.parent4Title == null &&
                        data.parent3Title != null
                    ) {
                        $("#ctab6")
                            .children("#ct6_title")
                        ...
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(255, 181, 20)");
                    }
                    if (
                        data.parent5Title == null &&
                        data.parent4Title != null
                    ) {
                        $("#ctab6")
                            .children("#ct6_title")
                        ...
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(221, 39, 42)");
                    }
                    if (
                        data.parent6Title == null &&
                        data.parent5Title != null
                    ) {
                        $("#ctab6")
                            .children("#ct6_title")
                        ...
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(68, 173, 26)");
                    }
                    if (
                        data.parent7Title == null &&
                        data.parent6Title != null
                    ) {
                        $("#ctab6")
                            .children("#ct6_title")
                        ...
                        $("#ctab7")
                            .children("#ct7_title")
                            .css("color", "rgb(127, 0, 255)");
                    }
                    if (
                        data.parent8Title == null &&
                        data.parent7Title != null
                    ) {
                        $("#ctab1")
                            .children("#ct1_title")
